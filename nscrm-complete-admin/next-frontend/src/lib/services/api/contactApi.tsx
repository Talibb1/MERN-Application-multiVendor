...
export const createContact = async (contact: CreateContactInput): Promise<ApiResponse<void>> => {
  try {
    const response = await axiosClient.post('contacts/createcontacts', contact);
...
export const getContacts = async (): Promise<ApiResponse<Contact[]>> => {
  try {
    const response = await axiosClient.get('contacts/getcontacts');
...
export const deleteContactById = async (id: number): Promise<ApiResponse<null>> => {
  try {
    const response = await axiosClient.delete(`contacts/deletecontacts/${id}`);
    return response.data;
  } catch (error: any) {
...
export const updateContactById = async (id: number, contactData: Partial<Contact>): Promise<ApiResponse<Contact>> => {
  try {
    const response = await axiosClient.put(`contacts/updatecontacts/${id}`, contactData);
    return response.data;
  } catch (error: any) {
...
export const getContactById = async (id: number): Promise<ApiResponse<Contact>> => {
  try {
    const response = await axiosClient.get(`contacts/getcontacts/${id}`);
    return response.data;
  } catch (error: any) {
